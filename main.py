...
# Set environment variables for OpenAI and Serper API
...
if not os.environ.get("SERPER_API_KEY"):
    raise ValueError("SERPER_API_KEY is not set in the environment. Please add it to your .env file.")


# Initialize the OpenAI GPT-4o-mini language model
